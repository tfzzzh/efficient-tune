...
def make_tensorboard_logger(trainer_config, prefix: str | None=None):
    import time
    ...
    log_string = "" if prefix is None else prefix

    # log_string = f"lr{trainer_config['learning_rate']}_wd{trainer_config['weight_decay']}" + \
    #     f"bs{trainer_config['batch_size']*trainer_config['gradient_accumulation_steps']}"
